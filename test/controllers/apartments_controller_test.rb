...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post apartments_url, params: { apartment: { address: @apartment.address, building_age: @apartment.building_age, name: @apartment.name, note: @apartment.note, rent: @apartment.rent } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { address: @apartment.address, building_age: @apartment.building_age, name: @apartment.name, note: @apartment.note, rent: @apartment.rent } }
